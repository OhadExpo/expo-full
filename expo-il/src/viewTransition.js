// NOTE: expo-il is a separate Vite app and cannot import from ../src, so this
// is a deliberate copy of src/viewTransition.js. Keep them in step — the
// hard-won notes below are the reason this file exists at all.
