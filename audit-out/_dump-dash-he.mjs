// Rendered Hebrew of /coach/dashboard (expandables opened) for a native read of composed lines.
// LOCAL output (task titles are his data): C:/Users/ADMINI~1/AppData/Local/Temp/claude/dash_he.txt
import P from 'puppeteer-core';
import fs from 'node:fs';
const wait = (ms) => new Promise((r) => setTimeout(r, ms));
const b = await P.connect({ browserURL: 'http://127.0.0.1:9222', defaultViewport: null, protocolTimeout: 300000 });
const pg = await b.newPage(); await pg.setViewport({ width: 1400, height: 1000 });
await pg.goto('http://127.0.0.1:4173/coach/dashboard?lang=he', { waitUntil: 'domcontentloaded' }); await wait(7000);
...
fs.writeFileSync('C:/Users/ADMINI~1/AppData/Local/Temp/claude/dash_he.txt', [...new Set(lines)].join('\n'));
