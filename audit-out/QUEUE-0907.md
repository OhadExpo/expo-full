...
- [ ] O13 deploy-0911 candidate: O-block edited App.jsx and auth.jsx (two of the five files held at production in the candidate) plus ui.jsx; the "diff must be 5 files" check will not hold until the candidate is rebuilt from the branch — rebuild it before asking him for the deploy
...
- [ ] O21 17.9: the Tasks bulk bar select button only shows on hover in the list layout — the O19 render check needs a hover step (audit-out/_tasks-bulkbar-he.mjs)
