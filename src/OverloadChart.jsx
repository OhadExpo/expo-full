...
export default function OverloadChart({ workouts, exercises }) {
  ...
  if (exerciseStats.length === 0) {
    return (
      <div style={{ color: C.tm, fontSize: 13, padding: 20, textAlign: 'center', background: 'transparent', border: `0.25px solid ${C.ac}4D`, borderRadius: 0 }}>
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(340px, 1fr))', gap: 10 }}>
        {sorted.map(row => {
          ...
          return (
            <div key={row.exId} style={{ background: 'transparent', border: `0.25px solid ${C.ac}4D`, borderRadius: 0, padding: 14 }}>
