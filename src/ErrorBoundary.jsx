...
export default class ErrorBoundary extends React.Component {
  ...
  render() {
    ...
    // Use literal colors (not theme tokens) since the theme system itself
    // might be the broken thing.
    return (
      <div style={{
        minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center',
        padding: 24, background: '#0a0a0c', color: '#f0f0f4',
        fontFamily: "'Nord', 'DM Sans', sans-serif",
      }}>
        <div style={{
          maxWidth: 520, width: '100%', background: '#111114',
          border: `1px solid rgba(57,189,255,0.30)`, padding: '28px 32px',
        }}>
          <div style={{
            fontSize: 9, fontWeight: 700, color: '#FF4757', letterSpacing: '0.18em',
            textTransform: 'uppercase', marginBottom: 14,
          }}>SOMETHING BROKE</div>
          <h1 style={{
            margin: '0 0 12px', fontSize: 22, fontWeight: 700, color: '#f0f0f4',
            letterSpacing: '-0.01em', lineHeight: 1.3,
          }}>EXPO hit a render error</h1>
          <p style={{
            margin: '0 0 18px', fontSize: 14, color: '#7a7a88', lineHeight: 1.55,
          ...
          <div style={{
            background: '#0a0a0c', border: `1px solid rgba(57,189,255,0.30)`,
            padding: '10px 12px', marginBottom: 18, fontSize: 11,
            fontFamily: 'monospace', color: '#FF4757', whiteSpace: 'pre-wrap',
            wordBreak: 'break-word', maxHeight: 120, overflow: 'auto',
          }}>{msg}</div>
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
            <button onClick={this.handleReload} style={{
              flex: 1, padding: '12px 18px', minWidth: 140,
              background: 'transparent', border: '1px solid #39BDFF',
              color: '#39BDFF', fontFamily: "'Nord', 'DM Sans', sans-serif",
            ...
            <button onClick={this.handleHardReset} style={{
              ...
              color: '#7a7a88', fontFamily: "'Nord', 'DM Sans', sans-serif",
              fontSize: 11, fontWeight: 700, letterSpacing: '0.18em',
              textTransform: 'uppercase', cursor: 'pointer',
            }}>Reset & reload</button>
          </div>
