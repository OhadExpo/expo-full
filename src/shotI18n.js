...
export const SHOT_I18N = {
  ...
  he: {
    ...
    handHint: 'זוהתה מהקליפ — לחץ כדי לקבוע בעצמך',
    ...
    oblique: 'הזריקה הזאת צולמה בזווית — הכדור התרחק מהמצלמה במקום לנוע לרוחב. הזווית וההשוואה בין החזרות עדיין טובות. המטרים והמ׳/שנ׳ יוצאים נמוכים. כדי למדוד אותם נכון, צלם מהצד, בניצב לכיוון הזריקה.',
    ...
    checks: {
      dip: {
        ...
        why: 'הרגליים הן המנוע. דיפ רדוד מדי משאיר ליד לייצר את הכוח — זריקה שטוחה שיוצאת רק מהידיים ונופלת קצר מטווח. דיפ עמוק מדי מאט את הקצב ונותן להגנה להתקרב. כיפוף ברך בינוני שומר גם על דחיפת רגליים וגם על קצב.',
      ...
      setElbow: {
        ...
        how: ['חזרות מול מראה: תביא את הכדור לסט וחפש את ה-L — אמה אנכית, זרוע עליונה מקבילה לרצפה.', 'זריקות פורמה ביד אחת, יד מכוונת מחוץ לכדור, מ-2 מ׳, 20 חזרות.'],
      },
      elbowAlign: {
      ...
      releaseArm: {
        ...
        why: 'זווית האמה בשחרור קובעת את זווית השיגור של הכדור. שטוחה מדי — חלון הכניסה לחישוק מצטמצם. תלולה מדי — מפסידים מרחק ותזמון. זו זווית היד. זווית הכדור האמיתית דורשת מעקב אחרי הכדור.',
      ...
      sequence: {
        ...
        how: ['חזרות איטיות "למטה-למעלה-החוצה": תרגיש שהרגליים מסיימות לפני שהיד יוצאת.', 'זריקות פורמה בתנועה אחת קרוב לחישוק, עם נסיגה הדרגתית — אותו סדר בכל מרחק.', 'דימוי: "דחוף את הרצפה, ואז את הכדור".'],
      },
      follow: {
        label: 'החזקת הליווי',
