...
export const SHOT_I18N = {
  en: {
    ...
    info: { dipToRelease: 'Dip → release', jumpRise: 'Jump rise', releaseHeight: 'Release height', armAtRelease: 'Arm at release', releaseVsApex: 'Release vs apex', chain: 'Chain (from dip)', tracked: 'Tracked' },
    ...
    footnote: 'Targets are coach-readable bands, not laws — read them with the athlete in front of you. Release arm angle is a proxy for the ball’s launch angle. Side-on filming is assumed for the trunk and elbow-offset reads.',
  ...
  he: {
    ...
    shotOf: (i, n) => `זריקה ${i} / ${n}`,
    atSec: (t) => `בשנייה ${t}`,
    scopeHint: (n) => `כרטיס הניקוד = הזריקה הזו · האימון = כל ${n}`,
    shotTip: (i, t, s) => `זריקה ${i} בשנייה ${t}, ניקוד ${s}`,

    info: { dipToRelease: 'דיפ → שחרור', jumpRise: 'גובה קפיצה', releaseHeight: 'גובה שחרור', armAtRelease: 'זווית יד בשחרור', releaseVsApex: 'שחרור מול שיא', chain: 'שרשרת (מהדיפ)', tracked: 'מעקב' },
    ...
    footnote: 'היעדים הם טווחים לקריאה של מאמן, לא חוקים — קרא אותם מול השחקן שעומד מולך. זווית היד בשחרור היא קירוב לזווית השיגור של הכדור. הקריאות של הגו וסטיית המרפק מניחות צילום מהצד.',
    ...
    checks: {
      ...
      setHeight: {
        ...
        how: ['זריקות פורמה לקיר: עמוד 30 ס״מ מהקיר, הבא את הכדור למצח והתמתח ישר למעלה בלי שהמרפק ייגע בקיר.', 'זריקה עם עצירה: החזק את הסט שנייה, בדוק ששורש כף היד בגובה הגבה, ואז שחרר.', 'קיו: "כדור למצח, לא לסנטר".'],
      },
      setElbow: {
        label: 'מרפק בסט',
      ...
      elbowAlign: {
        ...
        how: ['תרגיל החלקה בקיר: כתף יד הזריקה לקיר, המרפק מלטף את הקיר לאורך כל היישור.', 'קיו: "מרפק לחישוק" — הוא מצביע על המטרה לפני שהיד יורה.', 'משמעת יד מכוונת: היד השנייה עוזבת את הכדור בסט, אף פעם לא דוחפת.'],
      },
      releaseExt: {
      ...
      releaseArm: {
        ...
        how: ['תרגיל קשת: תזרוק מעל מטרה 30–40 ס״מ מעל החישוק (יד של שותף על ארגז) — רק סוויש.', 'קיו: "תזרוק למעלה, לא לכיוון" — כוון לנקודה הגבוהה של הקשת, לא לחישוק.', 'צלם מהצד: אצבעות הליווי מסיימות גבוה, לא מצביעות שטוח על החישוק.'],
      },
      timing: {
      ...
      sequence: {
        ...
        how: ['חזרות איטיות "למטה-למעלה-דרך": תרגיש שהרגליים מסיימות לפני שהיד יוצאת.', 'זריקות פורמה בתנועה אחת קרוב לחישוק, עם נסיגה הדרגתית — אותו סדר בכל מרחק.', 'קיו: "תדחוף את הרצפה, ואז את הכדור".'],
      },
      follow: {
        label: 'החזקת הליווי',
        ...
        how: ['"תחזיק עד שזה נוגע" — הקפא את הסיום עד שהכדור מגיע לחישוק, בכל חזרה, אימון שלם.', 'קיו: "יד בתוך צנצנת העוגיות" — אצבעות יורדות מעל החישוק בסיום.'],
      },
      trunk: {
        label: 'הגו בשחרור',
