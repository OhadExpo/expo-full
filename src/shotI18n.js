...
export const SHOT_I18N = {
  en: {
    ...
    footnote: 'Targets are coach-readable bands, not laws — read them with the athlete in front of you. Release arm angle is the ARM; when the ball itself could be tracked, its true launch angle is shown beside it. Side-on filming is assumed for the trunk and elbow-offset reads.',
  ...
  he: {
    ...
    footnote: 'היעדים הם טווחים לקריאה של מאמן, לא חוקים — קרא אותם מול השחקן שעומד מולך. זווית היד בשחרור היא של היד; כשאפשר לעקוב אחרי הכדור עצמו, זווית השיגור האמיתית שלו מוצגת לצידה. הקריאות של הגו וסטיית המרפק מניחות צילום מהצד.',
