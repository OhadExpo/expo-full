...
export const SHOT_I18N = {
  ...
  he: {
    ...
    summary: (f, w, o, q, p, fps) => `${f} לתיקון · ${w} למעקב · ${o} תקינות · מעקב ${q} (${p}% מפריימי הזריקה) · ${fps} פריימים לשנייה`,
    ...
    checks: {
      dip: {
        ...
        why: 'הרגליים הן המנוע. דיפ רדוד מדי משאיר ליד לייצר את הכוח — זריקה שטוחה שיוצאת רק מהידיים ונופלת קצרה מרחוק. דיפ עמוק מדי מאט את הקצב ונותן להגנה להתקרב. כיפוף ברך בינוני שומר גם על דחיפת רגליים וגם על קצב.',
