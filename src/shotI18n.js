...
export const SHOT_I18N = {
  en: {
    ...
    vsLastHead: (d) => `vs your last session (${d})`,
  ...
  he: {
    ...
    vsLastHead: (d) => `מול האימון הקודם (${d})`,
    vsScore: (was, now) => `${was} ← ${now}`,
    vsBetter: 'השתפר מאז',
    vsWorse: 'ירד מאז',
    ...
    checks: {
      ...
      follow: {
        ...
        why: 'הליווי הוא העדות ליישור מלא ופריקת שורש כף היד. הורדת היד מוקדם כמעט תמיד אומרת שהפריקה נקטעה, וזה עולה בסיבוב האחורי שמרכך את הכדור.',
