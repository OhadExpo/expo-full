        ...
        {!loaded && (
          <div style={{
            ...
            <div style={{
              ...
              border: `2px solid ${C.cardBd}`, borderTopColor: C.ac,
...
function PricingTier({ name, slots, popular, features, cta, price, priceSub, popularLabel, isHe }) {
  return (
    <div style={{
      ...
      border: popular ? `1px solid ${C.ac}` : `0.25px solid ${C.cardBd}`,
...
export default function CoachLanding({ lang = 'en' }) {
  ...
  return (
    ...
    <div dir={isHe ? 'rtl' : 'ltr'} data-theme="dark" style={{
      ...
      <style>{`
        ...
        @media (max-width: 720px) {
          ...
          /* Header items that overcrowd the row on narrow screens. The
             ...
             !important needed because baseBtn spreads display:inline-flex
             as inline style, which beats a stylesheet rule on specificity. */
          .cl-header-badge,
      ...
      {/* Header */}
      <header style={{
        background: C.bg, borderBottom: `0.25px solid ${C.cardBd}`,
      ...
      <div className="cl-sticky-cta" style={{
        ...
        background: C.bg, borderTop: `0.25px solid ${C.cardBd}`,
      ...
      <footer style={{
        borderTop: `0.25px solid ${C.cardBd}`, padding: '20px 16px',
