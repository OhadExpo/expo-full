...
export const INTAKE_HE = {
  ...
  intro: 'מלא את הטופס פעם אחת. הנתונים יגיעו ישירות אל המאמן ויעזרו להתאים את התוכנית.',
  submitLabel: 'שליחה',
  ...
  questions: [
    ...
    { id: 'gym_first',     type: 'choice',    label: 'זו הפעם הראשונה שלך בחדר כושר?', required: true, choices: ['כן (אני חדש לחלוטין)', 'לא (התאמנתי בעבר)'] },
    { id: 'gym_longest',   type: 'short',     label: 'אם התאמנת בעבר — כמה זמן בערך הייתה תקופת האימונים הארוכה ביותר?' },
    ...
    { id: 'weight_history',type: 'paragraph', label: 'האם היית בעבר כבד מאוד או רזה מאוד? פרט.', required: true },
    { id: 'injuries',      type: 'paragraph', label: 'האם נפצעת בעבר? פרט.', required: true },
    ...
    { id: 'lifestyle',     type: 'paragraph', label: 'הרגלים חדשים או שינוי באורח חיים שאתה רוצה לעבוד עליו?' },
...
export const PROGRESS_HE = {
  ...
  questions: [
    ...
    { id: 'frequency',       type: 'choice',    label: 'האם תרצה להתאמן מספר ספציפי של אימונים שבועיים?', required: true, choices: ['לא, אני דינמי ואתאמן בהתאם לתוכנית', 'אחר'] },
...
export const ASSESSMENT_HE = {
  ...
  intro: 'ממלאים פעם אחת. הנתונים האלה הם קו הבסיס שממנו נבנה הבלוק הראשון. בדיקות עצמיות פשוטות — לא צריך מד-קומה או מד-זווית.',
  submitLabel: 'שליחה',
  thanksTitle: 'תודה!',
