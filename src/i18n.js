...
export const HE = {
  ...
  'Low Sessions': 'נגמרים אימונים',
  'Estimated Monthly': 'צפי חודשי',
  'Collected MTD': 'נגבה החודש',
  REVENUE: 'הכנסות',
  'MRR (ACTIVE)': 'הכנסה חודשית קבועה',
  'RECURRING COMMITTED': 'מחויב וחוזר',
  '30D COLLECTED': 'נגבה ב-30 יום',
  '90D COLLECTED': 'נגבה ב-90 יום',
  OUTSTANDING: 'חוב פתוח',
  'AVG LTV': 'שווי ממוצע ללקוח',
  'AVG TICKET': 'תשלום ממוצע',
  'PER PAYING CLIENT': 'לכל לקוח משלם',
  'PER PAYMENT ROW': 'לכל תשלום',
  'TRAILING 3 MONTHS': 'שלושת החודשים האחרונים',
  'INCL. VAT · 6 MO TREND': 'כולל מע״מ · מגמת חצי שנה',
  'LAST 6 MONTHS · COLLECTED': 'חצי שנה אחרונה · נגבה',
  'NO PAYMENTS MARKED COLLECTED IN THE LAST 6 MONTHS': 'לא נרשמו תשלומים שנגבו בחצי השנה האחרונה',
  STORAGE: 'אחסון',
  TASKS: 'משימות',
  ...
  'Never trained': 'עוד לא התאמן',
  'Never paid': 'עוד לא שילם',
