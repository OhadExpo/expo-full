...
export const HE = {
  ...
  "Accommodation — same sets & reps ≥2 blocks. Change the load or the drill.": "התרגלות — אותם סטים וחזרות שני בלוקים ומעלה. תשנה משקל או תרגיל.",
  ...
  "Discard this program's override and show the library cues again. Doesn't touch the library.": "לבטל את הדריסה של התוכנית ולחזור לדגשים מהספרייה. הספרייה עצמה לא משתנה.",
  "Auto-prefilled from the exercise library — start typing to override for this program only": "הגיע מהספרייה — תתחיל להקליד כדי לדרוס רק בתוכנית הזאת",
  ...
  "Add by name only — no library link, notes, or video; won't be reusable": "הוספה בשם בלבד — בלי קישור לספרייה, הערות או סרטון; ואי אפשר יהיה להשתמש בו שוב",
  ...
  "Realtime sync dropped — changes may take up to 90s to appear until it reconnects": "הסנכרון החי נפל — עד שיחזור, שינויים יכולים לקחת 90 שניות להופיע",
  ...
  "Bar velocity (VBT), ROM, tempo & collapse flags from this clip": "מהירות המוט (VBT), טווח תנועה, טמפו והתמוטטות — מהקליפ הזה",
  ...
  "Order bumper plates (20kg × 4)": 'להזמין באמפרים (20 ק"ג × 4)',
  "Noa — deload week, cut volume 30%": "נועה — שבוע הורדה, לחתוך 30% נפח",
  ...
  "Preview this athlete's portal (demo only)": "תצוגה של הפורטל שלו (בדמו בלבד)",
  "Demo only — mute this athlete's notifications": "בדמו בלבד — השתקת ההתראות של המתאמן",
  "SET": "שינוי סטטוס:",
