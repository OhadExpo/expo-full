...
export const HE = {
  ...
  "Mark reviewed and return to the queue (demo only)": "לסמן כנבדק ולחזור לתור (רק בדמו)",
  ...
  "Add by name only — no library link, notes, or video; won't be reusable": "הוספה רק בשם — בלי קישור לספרייה, הערות או סרטון; ואי אפשר יהיה להשתמש בו שוב",
