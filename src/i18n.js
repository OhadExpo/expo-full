...
export const HE = {
  ...
  "Not trained in the latest block — add it to the next one": "לא אומן בבלוק האחרון — תוסיף אותו לבלוק הבא",
  ...
  "Create a reusable library exercise (edit details later in Exercises)": "יצירת תרגיל בספרייה לשימוש חוזר (אפשר להשלים פרטים אחר כך)",
  ...
  "Plan Q3 athlete testing day": "לתכנן יום מדידות לרבעון הבא",
  ...
  "Preview this athlete's portal (demo only)": "תצוגה של הפורטל שלו (רק בדמו)",
  ...
  'Could not reach the server. An ad-blocker or privacy extension, a VPN, or a stale offline cache can block it — try an incognito window, or clear this site’s data.': 'אין חיבור לשרת. חוסם פרסומות, VPN או מטמון ישן יכולים לחסום את החיבור — נסה חלון גלישה בסתר, או נקה את נתוני האתר.',
