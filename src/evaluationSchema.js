...
export const EVAL_SCHEMA = {
  sections: [
    ...
    },
    {
      ...
      hint: 'Tap 1–3 per side (1 red · 2 orange · 3 green). Watch the parameters listed for each movement.',
      // `params` = the "parameters to watch" from the ATH EVAL sheet — what the
      // coach observes while the client performs the movement, to inform the
      // 1–3 score. Reference only: never scored, never persisted. Obvious source
      // typos corrected (Stablility→Stability, Strenth→Strength,
      // Diaphramic→Diaphragmatic, Rectraction→Retraction).
      tests: [
        { id: 'bw_lunge',         label: 'BW Standing Lunge',              goal: '8 reps E',          sides: ['L', 'R'],
          params: ['Hip Extension (Strength, Mobility)', 'Knee Flexion+Extension (Stability)', 'Ankle Dorsal-Flexion (Mobility)'] },
        { id: 'bw_alt_lunge',     label: 'BW Alternating Lunge',           goal: '8 reps E',          sides: ['L', 'R'],
          params: ['Hip External Rotation (Mobility, Stability)', 'Knee Flexion+Extension (Strength, Stability)', 'Ankle Inversion (Mobility, Stability)', 'Foot Pronation (Mobility)'] },
        { id: 'bw_rfess',         label: 'BW RFESS',                       goal: '8 reps E',          sides: ['L', 'R'],
          params: ['Hip Internal Rotation+Flexion (Mobility, Stability)', 'Knee Flexion+Extension (Strength, Stability)', 'Ankle Eversion (Mobility, Stability)', 'Foot Arches (Mobility)'] },
        { id: 'bw_squat',         label: 'BW Squat',                       goal: '2 sets × 5 reps',
          params: ['Hip Rotation (Mobility)', 'Knee External Rotation (Mobility, Stability)', 'Ankle+Foot (Mobility, Stability)'] },
        { id: 'sl_hip_thrust',    label: 'Single Leg Hip Thrust',          goal: '2 sets × 5 reps E', sides: ['L', 'R'],
          params: ['Hip Internal Rotation+Extension (Strength, Mobility)', 'Knee Extension (Strength, Stability)', 'Trunk (Strength, Diaphragmatic Control)'] },
        { id: 'dh_scap_pr',       label: 'Dead-Hang Scapula PRO/RET',      goal: '8 reps',
          params: ['Scapula Depression+Elevation (Strength, Mobility)', 'Elbow Extension (Mobility, Stability)', 'Wrist (Strength)'] },
        { id: 'pu_scap_pr',       label: 'Push-Up Stance Scapula PRO/RET', goal: '12 reps',
          params: ['Scapula Retraction+Protraction (Strength, Stability, Mobility)', 'Elbow Extension (Strength, Stability)', 'Wrist Extension (Strength, Mobility)'] },
        { id: 'push_up',          label: 'Push-Up',                        goal: 'reps (RPE 5-6)',
          params: ['Scapula Movement (Mobility)', 'Shoulder External Rotation (Mobility, Stability)', 'Elbow Extension (Strength, Stability)', 'Wrist Extension (Strength)', 'Trunk (Strength)'] },
        { id: 'sup_inverted_row', label: 'Supinated Inverted Row',         goal: 'reps (RPE 5-6)',
          params: ['Shoulder (Internal Rotation)', 'Elbow Flexion (Strength)', 'Trunk (Strength)'] },
        { id: 'hollow_hold',      label: 'Hollow Hold',                    goal: '2 sets × 10 sec',
          params: ['Neck Flexion (Strength/Stability)', 'Hip Flexion (Strength/Stability)', 'Trunk (Strength + Diaphragmatic Control)'] },
        { id: 'wall_toss',        label: 'Alternate-Hand Wall Toss',       goal: '2 sets × 4 reps E',
          params: ['Coordination/Hip Rotation'] },
        { id: 'db_rdl',           label: 'DB RDL',                         goal: '2 sets × 5 reps',
          params: ['Hip Extension (Mobility)', 'Hip Flexion (Strength)', 'Knee External Rotation (Mobility, Stability)', 'Trunk (Strength + Diaphragmatic Control)'] },
        { id: 'fh_bstance_rdl',   label: 'Floating Heel B-Stance DB RDL',  goal: '2 sets × 4 reps E', sides: ['L', 'R'],
          params: ['Hip Internal Rotation w Hinge (Mobility, Stability)', 'Foot (Pronation)'] },
        { id: 'hk_cable_row',     label: 'Half-Kneeled SA Cable Row',      goal: '8 reps E',          sides: ['L', 'R'],
          params: ['Scapula Upward/Downward Rotation (Mobility, Stability)', 'Shoulder Internal Rotation (Strength, Mobility)', 'Trunk (Strength + Diaphragmatic Control)'] },
      ],
    },
  ],
