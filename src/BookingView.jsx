    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <CollapsibleSection title={tt('Booking Settings')} storageKey="cal-settings" style={{ marginBottom: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          <code style={{ fontSize: 12, color: C.ac, background: 'var(--c-sf)', height: 'var(--btn-h)', boxSizing: 'border-box', display: 'inline-flex', alignItems: 'center', padding: '0 10px', border: `1px solid ${C.cardBd}`, wordBreak: 'break-all', minWidth: 0 }}>
