...
export const HE = {
  ...
  'Concussion — Graduated Return to Sport': 'חבלת ראש — חזרה מדורגת למשחק',
  'Symptom-limited activity': 'פעילות ללא תסמינים',
  ...
  'Walking or stationary bike, low intensity. No resistance training.': 'הליכה או אופניים נייחים בעוצמה נמוכה. בלי אימון התנגדות.',
  'Sport-specific': 'ספציפי לענף',
  'Running and court movement, alone. No head-impact activity.': 'ריצה ותנועה על המגרש, לבד. בלי פעולות שיש בהן מכות ראש.',
  'Non-contact drills': 'תרגילים ללא מגע',
  'Harder drills, passing, change of direction. Resistance training may resume.': 'תרגילים קשים יותר, מסירות, שינויי כיוון. אפשר לחזור לאימון התנגדות.',
  ...
  'Pacing': 'קצב',
  'At least 24 hours per step. If symptoms come back, go back one step and try again after 24 hours symptom-free.': 'לפחות 24 שעות בכל שלב. אם התסמינים חוזרים, תחזור שלב אחד אחורה ותנסה שוב אחרי 24 שעות בלי תסמינים.',
  ...
  'Steps 5 and 6 need medical clearance. This screen tracks the plan; it does not clear anyone to play.': 'שלבים 5 ו-6 דורשים אישור רפואי. המסך הזה מנהל את התוכנית, הוא לא מאשר לאף אחד לשחק.',
